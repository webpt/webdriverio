...
export declare const cmdArgs: {
    ...
    readonly tsNodeOpts: {
        readonly desc: "ts-node options";
    };
};
export declare const builder: (yargs: yargs.Argv<{}>) => yargs.Argv<yargs.Omit<{}, "framework" | "reporters" | "hostname" | "port" | "path" | "baseUrl" | "spec" | "user" | "key" | "logLevel" | "waitforTimeout" | "watch" | "bail" | "suite" | "exclude" | "mochaOpts" | "jasmineNodeOpts" | "cucumberOpts" | "tsNodeOpts"> & yargs.InferredOptionTypes<{
    readonly watch: {
        readonly desc: "Run WebdriverIO in watch mode";
        readonly type: "boolean";
    };
